...
echo("Tabelka - Pracownicy tylko z działu 2");
echo("SELECT imie, zarobki, data_urodzenia, nazwa_dzial FROM pracownicy, organizacja WHERE dzial = id_org and dzial = 2");
